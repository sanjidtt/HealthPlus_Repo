                ...
                Expanded(
                  child: BoxBmi(
                    boxColor: gender == Gender.Female
                        ...
                        : Color(0xFF111328),
                    boxChild: BoxDetails(
                        iconName: FontAwesomeIcons.venus, label: 'FEMALE'),
                    onPressed: () {
                      setState(() {
            ...
            child: GestureDetector(
              onTap: () {
                ...
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            Result(bmi: bmi, comment: comment)));
              },
              child: Container(
                  child: Center(
  ...
  Widget build(BuildContext context) {
    return Column(
      ...
      children: <Widget>[
        ...
        Text(
          label,
          style: TextStyle(color: Color(0xFF8D8E98), fontSize: 15.0),
        ),
      ],
    );
  }
