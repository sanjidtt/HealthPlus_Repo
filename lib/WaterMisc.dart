              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: <Widget>[
                    ...
                    Text("REMIND YOURSELF TO DRINK WATER", style: TextStyle(fontSize: 18,fontWeight: FontWeight.w400)),
                    SizedBox(
                      height: 35,
                    ),
                    Row(
                      children: <Widget>[
                        ...
                        Text("Notify Me After   ", style: TextStyle(fontSize: 15,fontWeight: FontWeight.w400)),
                        SizedBox(
                          width: 30,
                          child: TextField(
                        ...
                        Text(" minutes ", style: TextStyle(fontSize: 15,fontWeight: FontWeight.w400),),
